...
export type DefinedFunctionBinding = HttpTriggerRequestBinding | HttpTriggerResponseBinding | TimerTriggerBinding;
 ...
 */
export type FunctionBinding<T = null> = T extends null ? DefinedFunctionBinding : CustomFunctionBinding;
